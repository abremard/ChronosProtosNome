      ...
      builder: (BuildContext context, double value, Widget? child) {
        ...
        return AnimatedBuilder(
          ...
          builder: (context, snapshot) {
            ...
            if (reducedValue < previousValue) {
              loopNumber += 1;
            }
            previousValue = reducedValue;
...
class _SimpleCircularProgressBarPainter extends CustomPainter {
  ...
  void _drawArcPart(Canvas canvas, Size size) {
    ...
    final Rect arcRect2 = const Offset(0, 100) & size;
    ...
    final Paint arcPaint2 = Paint()
      ..shader = frontGradient.createShader(arcRect2)
      ..strokeWidth = progressStrokeWidth
      ..strokeCap = StrokeCap.round
      ..style = PaintingStyle.stroke;

    if (loopNumber % 2 == 0) {
      canvas.drawArc(arcRect, _degToRad(90), sweepAngle, false, arcPaint);
      canvas.drawArc(arcRect2, _degToRad(270), _degToRad(360) - sweepAngle,
          false, arcPaint2);
    } else {
      canvas.drawArc(
